...
import com.jiacong.cofig.ResourceConfig;
...
//	public static final String ZOOKEEPER_SERVER = "10.211.55.6:2181";
	...
	public void init() {
		...
		try {
//			String testNodeData = new String(client.getData().forPath("/bgm/200321AC9W11P568"));
...
//					String songPath = bgm.getPath();
					...
					// 2. 定义保存到本地的bgm路径
//					String filePath = "/Users/jiacongluo/Document/Documents/jiacong_videos_dev" + songPath;
...
//					String bgmUrl = "http://192.168.2.101:8080/mvc" + finalPath;
