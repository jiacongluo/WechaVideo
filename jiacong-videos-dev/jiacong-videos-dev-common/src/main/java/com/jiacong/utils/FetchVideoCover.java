...
//		ffmpeg.exe -ss 00:00:01 -i spring.mp4 -vframes 1 bb.jpg
	...
	public static void main(String[] args) {
		// 获取视频信息。
		FetchVideoCover videoInfo = new FetchVideoCover("/usr/local/Cellar/ffmpeg/4.2.2_2/bin/ffmpeg");
		try {
			videoInfo.getCover("/Users/jiacongluo/Movies/Videos/BlackSpiderXNoVoice.mp4","/Users/jiacongluo/Movies/Videos/BlackSpiderXNoVoice.jpg");
